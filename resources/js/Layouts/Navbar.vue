<template>
  <nav class="navbar navbar-expand navbar-light navbar-bg" style = "background-color:white;color:#090c29;">
      ...
      <ul class="navbar-nav navbar-align">
        <li class="nav-item dropdown">
          <a class="nav-icon dropdown-toggle" href="#" id="alertsDropdown" data-bs-toggle="dropdown"
            ...
            <div class="position-relative">
              ...
              <span class="indicator" style="background:#090c29;">{{ page.props.notifications.length }}</span>
        ...
        <li class="nav-item dropdown">
          <a class="nav-icon dropdown-toggle d-inline-block d-sm-none" href="#" data-bs-toggle="dropdown">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
              stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" s
              class="feather feather-settings align-middle" style = "color:#090c29;">
          ...
          <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
            <span style = "color:#090c29;">{{ user.name }}</span>
          </a>
