                                ...
                                <div class="tab-pane active show" id="tab-1" role="tabpanel">
                                    ...
                                    <form @submit.prevent="submitResearch">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select :disabled="alreadySubmitted"  v-model="form.adviser_id" class="form-control mb-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <label class="form-label" for="inputAddress">For Scheduling?</label>
                                                <select :disabled="!studentPaper || !studentPaper.is_approved_by_adviser" v-model="form.for_scheduling" class="form-control mb-3">
...
const { advisers, alreadySubmitted, studentPaper, adviserComments, panelMemberComments } = defineProps({
    advisers: Object,
